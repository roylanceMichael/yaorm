...
var _root = dcodeIO.ProtoBuf.newBuilder({})['import']({
    ...
    "enums": [
        ...
        {
            "name": "SelectFunctionType",
            "values": [
                {
                    "name": "NONE_SELECT_FUNCTION_TYPE",
                    "id": 0
                },
                {
                    "name": "COUNT_SELECT_FUNCTION_TYPE",
                    "id": 1
                },
                {
                    "name": "MAX_SELECT_FUNCTION_TYPE",
                    "id": 2
                },
                {
                    "name": "MIN_SELECT_FUNCTION_TYPE",
                    "id": 3
                },
                {
                    "name": "SUM_SELECT_FUNCTION_TYPE",
                    "id": 4
                }
            ]
        },
