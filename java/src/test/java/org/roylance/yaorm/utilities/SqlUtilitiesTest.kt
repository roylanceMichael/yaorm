...
class SqlUtilitiesTest {
    ...
    fun bulkInsertTest() {
        // arrange
        val sqliteGeneratorService = SQLiteGeneratorService()
        val expectedSql = """replace into "BeaconBroadcastModel" ("id","beaconId","majorId","minorId","active","cachedName","lastSeen")  select '0' as "id",'test1' as "beaconId",0 as "majorId",0 as "minorId",0 as "active",'test1' as "cachedName",0 as "lastSeen"
